...
import com.example.aplikacija_oapp.ui.components.Post2Form
import com.example.aplikacija_oapp.ui.components.Post2Item
...
fun IscemNadomescanje() {
    ...
    ScreenLayout() {
        AppHeader(title = "IŠČEM NADOMEŠČANJE")
